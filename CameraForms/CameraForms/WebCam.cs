...
namespace CameraForms
{
    ...
    lParam);
        ...
        {
            SendMessage(hHwnd, WM_CAP_FILE_SET_CAPTURE_FILE, 0, "film.avi");
            SendMessage(hHwnd, WM_CAP_SEQUENCE, DeviceID, 0);
        }

        public void StopRecording()
        {
            SendMessage(hHwnd, WM_CAP_FILE_SAVEAS, DeviceID, "film.avi");
            SendMessage(hHwnd, WM_CAP_STOP, DeviceID, "film.avi");
        }

        public void SaveImage()
        {
            SendMessage(hHwnd, WM_CAP_SAVEDIB, DeviceID, "zrzut.jpg");
